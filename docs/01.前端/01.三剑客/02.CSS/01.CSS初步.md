...
![图解CSS声明](https://gitee.com/Chailar/image/raw/master/img/css-declaration.png)
...
![three boxes sat inside one another. From outside to in they are labelled margin, border and padding](https://gitee.com/Chailar/image/raw/master/img/box-model.png)
